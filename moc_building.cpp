...
**
** Created: Tue May 7 20:24:20 2013
...
void Building::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Building *_t = static_cast<Building *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Building::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Building::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Building,
      qt_meta_data_Building, &staticMetaObjectExtraData }
};
...
void *Building::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Thing"))
        return static_cast< Thing*>(const_cast< Building*>(this));
